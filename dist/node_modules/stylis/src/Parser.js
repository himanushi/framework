import { RULESET as B, DECLARATION as F, COMMENT as G } from "./Enum.js";
import { from as q, strlen as E, append as L, charat as I, replace as M, indexof as H, sizeof as J, substr as O, abs as K, trim as P } from "./Utility.js";
import { dealloc as Q, alloc as V, next as R, prev as W, peek as x, delimit as y, identifier as X, commenter as Y, escaping as Z, whitespace as _, node as D, char as $, caret as z } from "./Tokenizer.js";
function ca(e) {
    ...
    switch (b = c, c = R()) {
      ...
      default:
        ...
        switch (a += q(c), c * s) {
          ...
          // @
          case 64:
            x() === 45 && (a += y(R())), h = x(), d = r = E(k = a += X(z())), c++;
            break;
          // -
          case 45:
            b === 45 && E(a) == 2 && (s = 0);
...
function S(e, o, n, f, m, w, T, v, g, l, d) {
  ...
  return D(e, o, n, m === 0 ? B : v, g, l, d);
}
function j(e, o, n) {
  return D(e, o, n, G, q($()), O(e, 2, -2), 0);
}
function U(e, o, n, f) {
